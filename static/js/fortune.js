...
(function() {
    ...
    const fortune = [
        ...
        '人类有史以来的所有发明中也许不包括手枪或龙舌兰酒计算机是让你犯错误最多最快的。',
        '程序员是值得尊敬的，程序员的双手是魔术师的双手，他们把枯燥无味的代码变成了丰富多彩的软件。',
        '如果大幅增加费用换来的只是性能可疑的提升，这种情况仅仅出现在赛马和女人身上才是让人可以容忍的。',
        ...
        '计算机总是越来越智能的。科学家告诉我们说不久它们就能跟我们对话了。',
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', showRandomFortune);
    } else {
        showRandomFortune();
    }
