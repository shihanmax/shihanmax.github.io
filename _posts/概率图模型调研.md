...
### 3.1 CRF模型的提出【https://repository.upenn.edu/cgi/viewcontent.cgi?article=1162&context=cis_papers】
...
后续，会继续讨论概率图模型或与其相关的一些概念间的区别和联系，如NB（朴素贝叶斯模型）和HMM、LR和CRF、HMM和CRF、随机过程与马尔可夫过程等。
