...
$f,g_1,g_2,...,g_R,h_1,h_2,...,h_{R'}$可微且一阶导数连续，可行解$x^{\star}$满足$\left\{\nabla h_{i}\left(x^{\star}\right): i=1,2, \ldots, R\right\} \bigcup\left\{\nabla g_{j}\left(x^{\star}\right): j \in I\left(x^{\star}\right)\right\}$是线性独立的。
